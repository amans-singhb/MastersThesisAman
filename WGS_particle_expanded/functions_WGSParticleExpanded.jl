...
function make_results(T_val, P_val, params, prob, save_val = 0.0001, a_tol = 1e-6, r_tol = 1e-6, parent_folder::String = "WGS_particle_expanded/results_particle_expanded_lab_parameters")
...
function make_plots(T_val, P_val, r_vals::Vector{Int}, t_stop = 0.0001, t_tot = 0.001, fig_folder::String = "WGS_particle_expanded/figures_particle_expanded_lab_parameters",  folder::String = "WGS_particle_expanded/results_particle_expanded_lab_parameters/param")
    if !isdir(fig_folder)
        mkdir(fig_folder)
    end
