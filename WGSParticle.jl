...
# F_0 = 10 # [mol/h]
# R_atmm3 = 8.2057e-2 # [m3 atm/kmol K]
...
C_c_i_init =  [35.64835739, 198.9711456, 195.2676773, 286.0622406, 11.97534371] # 0.75 * C_i_val
...
write_to_csv("C_c_1.csv", sol[C_c_1(t, r)])
write_to_csv("C_c_2.csv", sol[C_c_2(t, r)])
write_to_csv("C_c_3.csv", sol[C_c_3(t, r)])
write_to_csv("C_c_4.csv", sol[C_c_4(t, r)])
write_to_csv("C_c_5.csv", sol[C_c_5(t, r)])
