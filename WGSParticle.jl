...
## Parameters ##
@parameters t r T_c R θ τ rad d_cat C_i[1:5]
...
## Variables ##
@variables C_c_1(..) C_c_2(..) C_c_3(..) C_c_4(..) C_c_5(..) P_c(t, r) D_1_m(t, r) D_2_m(t, r) D_3_m(t, r) D_4_m(t, r) D_5_m(t, r) r_1(t, r) r_2(t, r) r_3(t, r) r_4(t, r) r_5(t, r) k_c_1(t) k_c_2(t) k_c_3(t) k_c_4(t) k_c_5(t)
...
# System
vars = [C_c_1(t, r), C_c_2(t, r), C_c_3(t, r), C_c_4(t, r), C_c_5(t, r), P_c, D_1_m, D_2_m, D_3_m, D_4_m, D_5_m, r_1, r_2, r_3, r_4, r_5, k_c_1, k_c_2, k_c_3, k_c_4, k_c_5]
params_scal = [T_c => T_c_val, R => R_atmm3, θ => θ_val, τ => τ_val, rad => rad_cat, d_cat => d_cat_val]
